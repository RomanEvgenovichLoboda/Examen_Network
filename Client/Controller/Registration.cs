...
namespace Client.Controller
{
    internal class Registration
    {
        ...
        public bool sidn_in;
        string connectionString = @"Data Source=DESKTOP-54SAU6R\SQLEXPRESS;Initial Catalog=Gamers;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        public void Regestration(string _email, string _pass)
        {
            try
            {
                ...
                if (IsRegistered) { MessageBox.Show("This E-mail is Exist !"); }
                else
                {
